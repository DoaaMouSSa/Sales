...
namespace Dto.Dto
{
    public class dtoPurchaseReturnForAdd
    {
    ...
    public class dtoPurchaseDetialsReturnForShow
    {
        public int id { get; set; }
        public int product_id { get; set; }
    ...
    public class dtoPurchaseInvReturnForShow
    {
        public int id { get; set; }
        ...
        public List<dtoPurchaseDetialsReturnForShow> lstProducts { get; set; }

...
namespace Dto.Dto
{
        public class dtoSalesReturnForAdd
        {
            ...
            public int sales_return__inv_id { get; set; }
            public string notes { get; set; }
        }
    public class dtoSalesReturnDetailsForShow
    {
        public int id { get; set; }
        public int product_id { get; set; }
        public string product_name { get; set; }
    ...
    public class dtoSalesReturnInvForShow
    {
            public int id { get; set; }
        ...
        public List<dtoSalesReturnDetailsForShow> lstProducts { get; set; }

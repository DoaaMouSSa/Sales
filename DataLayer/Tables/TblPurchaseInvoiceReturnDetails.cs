...
{
   public class TblPurchaseInvoiceReturnDetails
    {
        ...
        public int purchase_return_inv_id { get; set; }
        public virtual TblPurchaseInvoiceReturn TblPurchaseInvoiceReturn { get; set; }

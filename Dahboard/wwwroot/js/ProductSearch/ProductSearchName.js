        ...
        $.ajax({
            ...
            success: function (result) {
                for (var i = 0; i < result.length; i++) {
                   ...
                   // var encodename = btoa(unescape(encodeURIComponent(row.product_name)));
                    //alert(encodename);
                  // str= encodename.replace(/=/g, "m");
                    //  alert(str);
                    //localStorage.setItem("proname", row.product_name);
                    var test = 'any';
                   ...
                   //alert(decodeURIComponent(escape(window.atob(encodename))));
                }
            }, complete: function () {

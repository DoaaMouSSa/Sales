...
function CloseQtyModal(id) {
    var element = document.getElementById("ForQtyModal" + id);
...
function GetData(id, name, price) {
    ...
    alert(qty);
    $('#purchaseTbl').append("<tr><td>" + id + "</td><td>" + name + "</td><td>style='width:25%'><input value=" + qty + " style='border:none;background-color:red;'></td><td>" + price + "</td><td>" + (qty * price) + "</td></tr>");
    is_existPurchase();
    getTotal();
}
